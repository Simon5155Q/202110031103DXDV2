...
const tileSize = 90;
    ...
    var chunkGroup;
    var s1, s2, s3, s4;
    var objImg1, objImg2, objImg3, objImg4, objImgnorm1, objImgnorm2, objImgnorm3, objImgnorm4;
    var vlcts = [1,-1, 1.2, -1.2, 1.9, -1.9];
    var rngvlcts;
    var testChar;
    var database;
    ...
    function preload(){
      ...
      objImg1 = loadAnimation("Images/tile001.png","Images/tile002.png","Images/tile003.png","Images/tile004.png","Images/tile005.png","Images/tile006.png","Images/tile007.png","Images/tile008.png");
      objImg2 = loadAnimation("Images/tile009.png","Images/tile010.png","Images/tile011.png","Images/tile012.png","Images/tile013.png","Images/tile014.png","Images/tile015.png","Images/tile016.png");
      objImg3 = loadAnimation("Images/tile019.png","Images/tile020.png","Images/tile021.png","Images/tile022.png","Images/tile023.png","Images/tile024.png","Images/tile025.png","Images/tile026.png");
      objImg4 = loadAnimation("Images/tile027.png","Images/tile028.png","Images/tile029.png","Images/tile030.png","Images/tile031.png","Images/tile032.png","Images/tile033.png","Images/tile034.png");
      objImgnorm1 = loadImage("Images/tile000.png");
      objImgnorm2 = loadImage("Images/tile009.png");
      objImgnorm3 = loadImage("Images/tile019.png");
      objImgnorm4 = loadImage("Images/tile027.png");
...
function setup(){
  newCanvas = createCanvas(displayWidth,displayHeight);
  button1 = createButton("character1");
  button1.position(displayHeight/2, displayWidth/4)

  button2 = createButton("character2");
  button2.position(displayHeight/2, displayWidth/5)
  ...
  obj.addAnimation("forward",objImg1);
  obj.addAnimation("left",objImg2);
  obj.addAnimation("down",objImg3);
  obj.addAnimation("right",objImg4);
  obj.depth = 5;
...
function draw(){
 ...
 button1.mousePressed(gamestate = 1);
//  button2.mousePressed()
 ...
 if(gamestate === 1){
      ...
      testChar = createSprite(displayWidth/2, displayHeight/2, char1.size, char1.size);
    
    
      rng = Math.round(random(displayWidth, displayWidth/4));
      rngy = Math.round(random(displayHeight, displayHeight/4));
      rngvlcts = Math.round(random(0,5));
...
function gamestate1(functionName,functionName1){
  
  functionName = checkKey();
  functionName1 = drawTerrain();
  functionName2 = getTile();
  functionName3 = update();
  functionName4 = mouseWheel();
  functionName5 = nonRepeat();
  functionName6 = spawnDragons();
    function checkKey() {
      // console.log("works");
      if (keyDown("W")) {
        y -= speed;
    ...
    function rngMovement(){
      for(var i=0;i<drgnGroup.length;i++){
        drgnGroup[i].velocityX = vlcts[rngvlcts];
        drgnGroup[i].velocityY = vlcts[rngvlcts];
        console.log(drgnGroup[i].velocityY);
      }
    }
    
    function animateObj(){
      if(keyWentDown("W")){
          obj.changeAnimation("forward",objImg1);
      }
      if(keyDown("A")){
          obj.changeAnimation("left",objImg2);
      }
      if(keyDown("S")){
          obj.changeAnimation("down",objImg3);
      }
      if(keyDown("D")){
          obj.changeAnimation("right",objImg4);
      }
    }
